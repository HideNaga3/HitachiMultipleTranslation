...
# 入力ファイル（テスト用200行版）
input_csv = r'C:\python_script\test_space\MitsubishiMultipleTranslation\core_files\for_import_インドネシア_test200.csv'
output_excel = r'C:\python_script\test_space\MitsubishiMultipleTranslation\output\比較用_インドネシア_test200.xlsx'

print('=' * 80)
print('3シート比較Excel作成（テスト版 - 200行）')
print('=' * 80)
